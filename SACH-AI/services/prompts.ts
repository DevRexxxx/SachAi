...
For each anomaly in the "anomalies" array, you MUST include a "box" array containing 4 floats: [ymin, xmin, ymax, xmax].
These values must be normalized between 0.0 and 1.0, representing the relative coordinates of the anomaly in the image (e.g., [0.1, 0.2, 0.5, 0.6]).
